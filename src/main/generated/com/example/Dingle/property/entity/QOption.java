...
public class QOption extends EntityPathBase<Option> {
    ...
    private static final long serialVersionUID = 73445677L;

    public static final QOption option = new QOption("option");

    public final NumberPath<Long> id = createNumber("id", Long.class);

    public final EnumPath<com.example.Dingle.property.type.OptionType> optionType = createEnum("optionType", com.example.Dingle.property.type.OptionType.class);
